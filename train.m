...
hiddenSize1 = 196;
hiddenSize2 = 100; % number of hidden units 
...
[theta info] = initialize(hiddenSize1,hiddenSize2, visibleSize);
...
[cost, grad] = sparseAutoencoderC(theta, info, visibleSize, hiddenSize1,hiddenSize2, lambda,  ...
